...
import { ComprobanteAccessKey, ComprobantesHeroView, ComprobantesTransitionPhase } from '../types/comprobantes.types';


const COLLAPSE_DURATION_MS = 240;
const RETURN_DURATION_MS = 320;

type UseComprobantesAccessStateReturn = {
...
export function useComprobantesAccessState(): UseComprobantesAccessStateReturn {
